...
function handleParticles(){
    ...
    if (((keys["ArrowLeft"] || keys["ArrowRight"] || keys["ArrowUp"] || keys["ArrowDown"])) && frogger.y > 250 && particlesArray.length < maxParticles + 10){
        for (let i = 0; i < 10; i++){
    ...
    if (((keys["ArrowLeft"] || keys["ArrowRight"] || keys["ArrowUp"] || keys["ArrowDown"])) && frogger.y < 250 && frogger.y > 100){
        for (let i = 0; i < 20; i++){
